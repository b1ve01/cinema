	...
	<view class="updateName">
		<uni-forms ref="userForm" :modelValue="userFormData">
			<uni-forms-item name="userName">
				<uni-easyinput class="inputBorder" v-model="userFormData.userName" :placeholder=this.userData.userName />
			</uni-forms-item>
		</uni-forms>
		<uni-list-item class="update_true" v-if="userFormData.userName" rightText="修改" clickable @click="update()" />
		<uni-list-item class="update_false" v-if="!userFormData.userName" :disabled="true" rightText="修改" />
	</view>

	<view>
		<!-- 提示窗示例 -->
		<uni-popup ref="alertDialog" type="dialog">
			<uni-popup-dialog :type="error" cancelText="关闭" confirmText="确定" content="是否确定修改名字" @confirm="dialogConfirm"
