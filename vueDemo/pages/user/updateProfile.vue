<template>
	<view class="updateProfile">
		<uni-forms ref="userForm" :modelValue="userFormData">
			<uni-forms-item name="userProfile">
				<uni-easyinput class="inputBorder" type="textarea" v-model="userFormData.userProfile" :placeholder=this.userData.userProfile />
			</uni-forms-item>
		</uni-forms>
		<uni-list-item class="update_true" v-if="userFormData.userProfile" rightText="修改" clickable @click="update()" />
		<uni-list-item class="update_false" v-if="!userFormData.userProfile" :disabled="true" rightText="修改" />
	</view>

	<view>
		<!-- 提示窗示例 -->
		<uni-popup ref="alertDialog" type="dialog">
			<uni-popup-dialog :type="error" cancelText="关闭" confirmText="确定" content="是否确定修改简介" @confirm="dialogConfirm"
