<template>
	<view class="scheduleCreate" v-if="this.flag1==1&&this.flag2==1&&this.flag3==1">
		...
		<view class="scheduleINFO">
			...
			" class="create_schedule" size="mini" @click="schedule_create()">新增场次信息</button>
			...
			|| this.scheduleData.schedulePrice==''
			|| this.scheduleData.scheduleDescription==''
			" class="create_schedule_false" size="mini">新增场次信息</button>
		...
		<view>
			<uni-popup ref="scheduleCreateDialog" type="dialog">
				<uni-popup-dialog :type="error" cancelText="关闭" confirmText="确定" content="是否新增该场次信息" @confirm="scheduleCreateConfirm"
